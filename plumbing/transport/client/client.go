...
import (
	...
	"github.com/yelirekim/go-git/plumbing/transport/file"
	"github.com/yelirekim/go-git/plumbing/transport/git"
	"github.com/yelirekim/go-git/plumbing/transport/http"
	"github.com/yelirekim/go-git/plumbing/transport/ssh"
)
